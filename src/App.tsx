    ...
    <div className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_20%_0%,rgba(192,160,98,0.14),transparent_26%),radial-gradient(circle_at_85%_18%,rgba(255,255,255,0.05),transparent_18%),linear-gradient(180deg,#050505_0%,#090909_48%,#070707_100%)] text-[#EDEDED]">
      <div className="mx-auto grid min-h-screen w-full min-w-0 max-w-[1600px] gap-3 px-2 py-2 sm:gap-4 sm:px-4 sm:py-4 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-6 lg:px-6">
        <aside className="min-w-0 rounded-[24px] border border-[#C0A062]/18 bg-[rgba(12,12,12,0.82)] p-3 shadow-[0_30px_90px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:rounded-[32px] sm:p-4">
          <div className="flex min-w-0 items-center gap-3 rounded-[22px] border border-[#C0A062]/18 bg-[linear-gradient(135deg,rgba(192,160,98,0.1),rgba(255,255,255,0.03))] px-3 py-3 sm:rounded-[28px] sm:px-4 sm:py-4"><div className="icon"><img src="/logo.png" alt="DataVista logo" /></div><div className="min-w-0"><button onClick={() => { setJumping(true); setVibgyorIndex((i) => (i + 1) % 7); go("dashboard"); setTimeout(() => setJumping(false), 700); }} className={cn("mt-1 inline-block max-w-full truncate whitespace-nowrap font-['Playfair_Display'] text-base font-semibold uppercase tracking-[0.18em] text-[#E7D19A] transition-all duration-300 hover:scale-[1.03] hover:text-[#F2DEAE] sm:text-xl sm:tracking-[0.28em]", jumping && "animate-bounce")} style={{ textShadow: "0 0 18px rgba(192,160,98,0.22)" }}>DATA VISTA</button></div></div>
