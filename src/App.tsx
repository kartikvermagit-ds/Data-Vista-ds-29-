    ...
    <div className="dv-app-root min-h-screen overflow-x-hidden bg-[#f4f2ee] dark:bg-[radial-gradient(circle_at_20%_0%,rgba(192,160,98,0.14),transparent_26%),radial-gradient(circle_at_85%_18%,rgba(255,255,255,0.05),transparent_18%),linear-gradient(180deg,#050505_0%,#090909_48%,#070707_100%)] text-slate-800 dark:text-[#EDEDED]">
      <div className="mx-auto grid min-h-screen w-full min-w-0 max-w-[1600px] gap-3 px-2 py-2 sm:gap-4 sm:px-4 sm:py-4 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-6 lg:px-6">
        <aside className="dv-sidebar min-w-0 rounded-[24px] border border-[#C0A062]/18 bg-white/80 dark:bg-[rgba(12,12,12,0.82)] p-3 shadow-[0_30px_90px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:rounded-[32px] sm:p-4">
          <div className="mb-4 sm:mb-6"><button onClick={() => { setJumping(true); setVibgyorIndex((i) => (i + 1) % 7); go("dashboard"); setTimeout(() => setJumping(false), 700); }} className={cn("block w-full origin-left transition-all duration-300 hover:scale-105", jumping && "animate-bounce")}><div className="text-center sm:text-left py-2 select-none"><h1 className="text-2xl sm:text-3xl font-extrabold tracking-[0.3em]"><span className="bg-gradient-to-b from-gray-200 via-gray-400 to-gray-600 bg-clip-text text-transparent drop-shadow-[0_2px_4px_rgba(255,255,255,0.3)]">DATA</span>{" "}<span className="bg-gradient-to-b from-yellow-200 via-yellow-400 to-yellow-600 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(234,179,8,0.8)] animate-[goldGlow_2s_infinite]">VISTA</span></h1><div className="flex items-center justify-center sm:justify-start gap-2 mt-2"><div className="h-[1px] w-6 bg-yellow-500 opacity-50"></div><p className="text-[9px] sm:text-[10px] text-yellow-400 tracking-[0.35em]">A VAST HORIZON OF INTELLIGENCE</p><div className="h-[1px] w-6 bg-yellow-500 opacity-50"></div></div></div></button></div>
